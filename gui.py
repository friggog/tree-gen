...
class TreeGenCustomisePanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.row()
        box.label(text="Number")
        label_row('', 'tree_branches_input', container=box)
        box.label(text="Length")
        label_row('', 'tree_length_input', container=box)
        box.label(text="Length Variation")
        label_row('', 'tree_length_v_input', container=box)
        box.label(text="Base Size")
        label_row('', 'tree_base_size_input', container=box)
        box.label(text="Distribution")
        label_row('', 'tree_branch_dist_input', container=box)
        box.label(text="Taper")
        label_row('', 'tree_taper_input', container=box)
        box.label(text="Radius Modifier")
        label_row('', 'tree_radius_mod_input', container=box)
        box.separator()
        box.label(text="Curve Bevel Resolution")
        label_row('', 'tree_bevel_res_input', container=box)
        box.label(text="Curve Resolution")
        label_row('', 'tree_curve_res_input', container=box)
        box.label(text="Curve")
        label_row('', 'tree_curve_input', container=box)
        box.label(text="Curve Variation")
        label_row('', 'tree_curve_v_input', container=box)
        box.label(text="Curve Back")
        label_row('', 'tree_curve_back_input', container=box)
        box.separator()
        box.label(text="Segment Splits")
        label_row('', 'tree_seg_splits_input', container=box)
        box.label(text="Split Angle")
        label_row('', 'tree_split_angle_input', container=box)
        box.label(text="Split Angle Variation")
        label_row('', 'tree_split_angle_v_input', container=box)
        box.separator()
        box.label(text="Bend Variation")
        label_row('', 'tree_bend_v_input', container=box)
        box.separator()
        box.label(text="Down Angle")
        label_row('', 'tree_down_angle_input', container=box)
        box.label(text="Down Angle Variation")
        label_row('', 'tree_down_angle_v_input', container=box)
        box.separator()
        box.label(text="Rotation")
        label_row('', 'tree_rotate_input', container=box)
        box.label(text="Rotation Variation")
        label_row('', 'tree_rotate_v_input', container=box)
        box.row()
